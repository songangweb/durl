  ...
  <div class="app-container">
    <div>
      ...
      <el-card style="margin-top: 20px">
        <div class="header">
          <el-button type="primary" @click="operation()"> 新增 </el-button>
          <div class="header-r">
            ...
            <el-radio-group style="margin-left: 10px">
              <el-button-group>
                <el-button type="primary" @click="bulkOperation(1)"
                  >批量冻结</el-button
                >
                <el-button type="primary" @click="bulkOperation(0)"
                  >批量解冻</el-button
                >
              </el-button-group>
            </el-radio-group>
            ...
            <el-table-column fixed="right" label="操作" width="120">
              <template slot-scope="scope">
                ...
                <el-button
                  type="text"
                  size="small"
                  @click="deleteOrFreezeValue(scope.row.id, '冻结')"
                  >冻结</el-button
                >
                <el-button
                  @click="deleteOrFreezeValue(scope.row.id, '删除')"
                  type="text"
                  size="small"
                  >删除</el-button
                >
    ...
    async getTableData(page) {
      ...
      this.tableData = data.list.map((v) => {
        return {
          ...
          expirationTime:
            v.expirationTime === 0 ? "永久" : dateFormat(v.expirationTime),
          fullUrl: v.fullUrl,
          id: v.id,
