...
func (l *LFU) RemoveOldest() (key interface{}, value interface{}, expirationTime int64, ok bool) {
	if l.Len() == 0 {
...
// GetOldest 返回最老的条目
func (l *LFU) GetOldest() (key interface{}, value interface{}, expirationTime int64, ok bool) {
